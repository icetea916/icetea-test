...
public class WebSocketSTOMPController {
    ...
    @SendToUser("/message")
    public Response handleSubscribe() {
        System.out.println("this is the @SubscribeMapping('/marco')");
        return new Response("I am a msg from SubscribeMapping('/macro').");
    }
    ...
    public Response send() {
        simpMessageSendingOperations.convertAndSendToUser("1", "/message", new Response("I am a msg from SubscribeMapping('/macro')."));
        return new Response("I am a msg from SubscribeMapping('/macro').");
    }
