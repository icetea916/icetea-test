 ...
 */
@Slf4j
public class SocketIOClientWithNameSpace2 {

    private static final String USERNAME = "icetea-namespace2";
...
//        options.port = 9099;
        ...
        // client创建,该方式设置是若服务端已/开头,则也要/开头
        Socket socket = IO.socket(url, options).io().socket("/namespace");
        // 事件绑定
