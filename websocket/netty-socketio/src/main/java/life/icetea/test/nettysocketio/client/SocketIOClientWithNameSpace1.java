 ...
 */
@Slf4j
public class SocketIOClientWithNameSpace1 {

    private static final String USERNAME = "icetea-namespace1";

    /**
     * 该方式连接namespace,服务端设置的namespace必须已/开头
     */
    public static String url = "http://127.0.0.1:9099/namespace?username=" + USERNAME;
